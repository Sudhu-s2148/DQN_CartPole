...
class RigidBody:
    ...
    def update(self, dt):
        ...
        self.vel = vec_add([self.vel, delta_v, vec_add(
            [scalar_mul(v.components, self.inv_M) for v in self.impulses]) if self.impulses else [0, 0]])
...
# walls
wall_r = RigidBody(
    shape=PolygonShape(points=[(50, -HEIGHT / 2), (-50, -HEIGHT / 2), (-50, HEIGHT / 2), (50, HEIGHT / 2)],
                       color=(0, 0, 0, 0)),
...
wall_u = RigidBody(shape=PolygonShape(points=[(WIDTH / 2, -50), (-WIDTH / 2, -50), (-WIDTH / 2, 50), (WIDTH / 2, 50)],
                                      color=(0, 0, 0, 0)),
                   M=None, I=None, pos=[WIDTH / 2, -50], static=True)

wall_d = RigidBody(shape=PolygonShape(points=[(WIDTH / 2, -50), (-WIDTH / 2, -50), (-WIDTH / 2, 50), (WIDTH / 2, 50)],
                                      color=(0, 0, 0, 0)),
